...
const fontOk = await p.evaluate(async () => { await document.fonts.ready; return document.fonts.check("20px Excalifont"); });
...
console.log(JSON.stringify({ tools, fontOk, mic, errors: errors.slice(0,5) }, null, 1));
await b.close();
