...
import { loadFilesFromFirebase } from "./data/euidosStorage";
import {
      ...
      <Excalidraw
        ...
        UIOptions={{
          canvasActions: {
            ...
            export: {
              onExportToBackend,
              // Excalidraw+ export is dropped in this deployment: it uploads the
              // scene to excalidraw.com through the Firebase SDK, which we no
              // longer bundle (boards live on our own backend).
